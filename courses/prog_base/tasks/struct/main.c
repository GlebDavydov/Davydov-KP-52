...
int main(){
	struct Student group[20] = {{1, "Adams Eric", 99}, {2, "Android", 100} , {3, "Attilla", 25}, {4, "Ceasar Gaius Julius", 101}, {5, "Davydov Glib", 43},
	{6, "Dickinson Bruce", 45}, {7, "Error: student not found", 404}, {8, "Faramir of Gondor", 56}, {9, "Hetfield James", 29}, {10, "Heretic! Mutant!", 0}, 
	{11, "Ivanov Ivan", 30}, {12, "Krysyuk Andriy", 50}, {13, "Kenny", 30}, {14, "Lindemann Tiel", 40}, {15, "Mustaine David", 99}, 

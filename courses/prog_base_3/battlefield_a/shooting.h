...
position track(land bf[n][m], int xs, int ys, int xd, int yd, battle_robot bot[TS]); //returns coords of the first obstacle or coords of destination if no obstacles
